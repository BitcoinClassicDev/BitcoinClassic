...
void ReceiveRequestDialog::update()
{
    ...
    QString uri = GUIUtil::formatBitcoinClassicURI(info);
    ...
    if(info.amount)
        html += "<b>"+tr("Amount")+"</b>: " + BitcoinClassicUnits::formatHtmlWithUnit(model->getOptionsModel()->getDisplayUnit(), info.amount) + "<br>";
...
{
    GUIUtil::setClipboard(GUIUtil::formatBitcoinClassicURI(info));
}
