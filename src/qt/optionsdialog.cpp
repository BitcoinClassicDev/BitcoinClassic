    ...
    mapper(nullptr)
{
    ...
    ui->openBitcoinClassicConfButton->setToolTip(ui->openBitcoinClassicConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new BitcoinClassicUnits(this));
...
void OptionsDialog::on_openBitcoinClassicConfButton_clicked()
{
    ...
    if (!GUIUtil::openBitcoinClassicConf())
