...
/** BitcoinClassic unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinClassicUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinClassicUnits(QObject *parent);

    /** BitcoinClassic units.
...
typedef BitcoinClassicUnits::Unit BitcoinClassicUnit;
