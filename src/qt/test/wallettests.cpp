...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<BitcoinClassicAmountField*>("payAmount")->setValue(amount);
...
void TestGUI(interfaces::Node& node)
{
    ...
    QString balanceComparison = BitcoinClassicUnits::formatWithUnit(unit, balance, false, BitcoinClassicUnits::separatorAlways);
    ...
    // Amount input
    BitcoinClassicAmountField* amountInput = receiveCoinsDialog.findChild<BitcoinClassicAmountField*>("reqAmount");
