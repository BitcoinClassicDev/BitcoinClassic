// Copyright (c) 2018 The BitcoinClassic Core developers
...
//! Entry point for BitcoinClassicApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinClassicApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinClassicGUI tests.
void AppTests::guiTests(BitcoinClassicGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinClassicGUI::consoleShown, this, &AppTests::consoleTests);
