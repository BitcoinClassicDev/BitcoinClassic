// Copyright (c) 2014-2019 The BitcoinClassic Core developers
...
BOOST_AUTO_TEST_CASE(sha256_testvectors) {
    ...
    TestSHA256("As BitcoinClassic relies on 80 byte header hashes, we want to have an example for that.",
