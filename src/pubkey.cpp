// Copyright (c) 2009-2018 The BitcoinClassicClassic Core developers
 ...
 *  BitcoinClassicClassic because since the activation of BIP66, signatures are verified to be
...
bool CPubKey::Verify(const uint256 &hash, const std::vector<unsigned char>& vchSig) const {
     ...
     * not historically been enforced in BitcoinClassicClassic, so normalize them first. */
