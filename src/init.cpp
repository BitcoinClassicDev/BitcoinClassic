...
/** Sanity checks
 *  Ensure that BitcoinClassicClassic is running in a usable environment with all
...
{
    // Make sure only a single BitcoinClassicClassic process is using the data directory.
