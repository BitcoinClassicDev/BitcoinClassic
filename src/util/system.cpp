...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Make sure BitcoinClassic Core copyright is not removed by accident
    if (copyright_devs.find("BitcoinClassic Core") == std::string::npos) {
        strCopyrightHolders += "\n" + strPrefix + "The BitcoinClassic Core developers";
    }
